...
class RoutesCommand extends GenerateCommand
{
     ...
     * @var string
     */
    protected $description = 'Append the default ussd controller routes to the routes.php';
    ...
    {
        if (! $restful) {
            return "The default Ussd routes (to use with the Controller template)".
            " will be appended to your routes.php file.";
        } else {
            return "A single route to handle every action in a RESTful controller".
            " will be appended to your routes.php file. This may be used with a ussd".
